...
#['_Processor', '_WIN32_CLIENT_RELEASES', '_WIN32_SERVER_RELEASES', '__builtins__', '__cached__', '
#__copyright__', '__doc__', '__file__', '__loader__', '__name__', '__package__', '__spec__', 
...
#'_java_getprop', '_libc_search', '_mac_ver_xml', '_node', '_norm_version', '_platform', 
...
#'_ver_output', '_ver_stages', 'architecture', 'collections', 'functools', 'itertools', 
